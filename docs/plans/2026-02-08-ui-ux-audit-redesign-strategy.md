...
|--------|--------|-----------------|
| Lead | 13 + refinement | AI service suggestion, file upload, custom_fields JSONB |
...
|-------------------|--------|----------|
| LeadsImportExport | Leads | 14 fields, Zod validation, aliases (fname→first_name) |
...
| Theme customization rate | Database query on ui_themes | ≥30% of tenants customize |
