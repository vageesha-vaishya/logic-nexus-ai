---
generated_at: 2026-01-31T05:09:11.597Z
...
## Banking & Finance
![Status](https://img.shields.io/badge/Status-planned-blue) ![Owner](https://img.shields.io/badge/Owner-Unassigned-green)

**Business Capability**: Loans, mortgages, and financial services
...
## Customs & Compliance
![Status](https://img.shields.io/badge/Status-active-blue) ![Owner](https://img.shields.io/badge/Owner-Compliance%20Squad-green)

**Business Capability**: Regulatory compliance, HTS codes, and clearance.

### Exposed APIs
- [OpenAPI Spec](/api/v1/customs/openapi.json)
- [Repository](https://github.com/trae/logic-nexus-ai)

### Dependencies
| Type | Domain | Description |
| :--- | :--- | :--- |
| downstream | Logistics & Transport | - |
...
**Business Capability**: E-Commerce and Retail
...
## Insurance Services
![Status](https://img.shields.io/badge/Status-active-blue) ![Owner](https://img.shields.io/badge/Owner-FinTech%20Squad-green)

**Business Capability**: Cargo and business liability insurance management.

### Exposed APIs
- [OpenAPI Spec](/api/v1/insurance/openapi.json)
- [Repository](https://github.com/trae/logic-nexus-ai)
...
**Business Capability**: Real Estate Management
...
**Business Capability**: Subscription billing and service management
...
## Trading & Procurement
![Status](https://img.shields.io/badge/Status-beta-blue) ![Owner](https://img.shields.io/badge/Owner-Trading%20Squad-green)

**Business Capability**: Sourcing, inspection, and trade finance services.

### Exposed APIs
- [OpenAPI Spec](/api/v1/trading/openapi.json)
- [Repository](https://github.com/trae/logic-nexus-ai)
