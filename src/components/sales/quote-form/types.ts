...
export const quoteSchema = z.object({
  ...
  shipping_term_id: z.string().optional(),
  ...
  schedule_b: z.string().optional(),
  hazmat_details: z.any().optional(),
  cargo_details: z.any().optional(),
  ...
  options: z.array(z.object({
    ...
    legs: z.array(z.object({
      ...
      transport_mode: z.string().nullable().optional(), // Relaxed from enum to support service legs
      service_only_category: z.string().nullable().optional(),
      leg_type: z.enum(['transport', 'service']).optional().default('transport'),
      carrier_id: z.string().nullable().optional(),
      origin_location_id: z.string().nullable().optional(),
      destination_location_id: z.string().nullable().optional(),
      origin_location_name: z.string().nullable().optional(),
      destination_location_name: z.string().nullable().optional(),
      ...
      charges: z.array(z.object({
        ...
        charge_code: z.string().nullable().optional(),
