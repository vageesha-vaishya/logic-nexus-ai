          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea placeholder="Describe what this template is for..." className="h-20" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Template Configuration</FormLabel>
                    <Tabs defaultValue="visual" className="w-full">
                      <TabsList className="grid w-full grid-cols-2">
                        <TabsTrigger value="visual">Visual Editor</TabsTrigger>
                        <TabsTrigger value="json">JSON Source</TabsTrigger>
                      </TabsList>
                      <TabsContent value="visual" className="pt-4 border rounded-md p-4 mt-2">
                        <VisualTemplateEditor 
                          ...
                          onChange={(newValue) => field.onChange(JSON.stringify(newValue, null, 2))} 
                        />
                      </TabsContent>
