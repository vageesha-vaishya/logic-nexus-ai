...
import { MaintenanceSchedule } from './widgets/MaintenanceSchedule';
import { CostAnalysis } from './widgets/CostAnalysis';
import { RouteEfficiency } from './widgets/RouteEfficiency';
import { WidgetInstance } from '@/types/dashboardTemplates';

const defaultWidgets: WidgetInstance[] = [
  { id: '1', type: 'fleet_status', title: 'Fleet Overview', size: 'large', position: 0 },
  { id: '2', type: 'maintenance_schedule', title: 'Maintenance Schedule', size: 'large', position: 1 },
  { id: '3', type: 'cost_analysis', title: 'Cost Analysis', size: 'large', position: 2 },
  { id: '4', type: 'route_efficiency', title: 'Route Efficiency', size: 'large', position: 3 },
];
...
export function FleetManagerDashboard() {
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-900">Fleet Manager Dashboard</h2>
        <p className="text-gray-600 mt-1">Track fleet status, maintenance, costs, and route efficiency</p>
      </div>
