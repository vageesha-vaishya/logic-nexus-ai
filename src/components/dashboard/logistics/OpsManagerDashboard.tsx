...
import { DailyOperationsSummary } from './widgets/DailyOperationsSummary';
import { WarehouseUtilization } from './widgets/WarehouseUtilization';
import { CostBreakdown } from './widgets/CostBreakdown';
import { PerformanceVsTarget } from './widgets/PerformanceVsTarget';
import { WidgetInstance } from '@/types/dashboardTemplates';

const defaultWidgets: WidgetInstance[] = [
  { id: '1', type: 'daily_operations_summary', title: 'Daily Operations', size: 'large', position: 0 },
  { id: '2', type: 'warehouse_utilization', title: 'Warehouse Utilization', size: 'large', position: 1 },
  { id: '3', type: 'cost_breakdown', title: 'Cost Breakdown', size: 'large', position: 2 },
  { id: '4', type: 'performance_vs_target', title: 'Performance vs Target', size: 'large', position: 3 },
];
...
export function OpsManagerDashboard() {
  ...
  const renderWidget = (widget: WidgetInstance) => {
    switch (widget.type) {
      ...
      case 'performance_vs_target':
        return <PerformanceVsTarget />;
      default:
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        <h2 className="text-3xl font-bold text-gray-900">Operations Manager Dashboard</h2>
        <p className="text-gray-600 mt-1">Monitor daily operations, warehouse, costs, and KPI performance</p>
      </div>
