...
import { TeamLeadDistribution } from './widgets/TeamLeadDistribution';
import { ForecastVsActual } from './widgets/ForecastVsActual';
import { WidgetInstance } from '@/types/dashboardTemplates';

const defaultWidgets: WidgetInstance[] = [
  { id: '1', type: 'team_leaderboard', title: 'Team Leaderboard', size: 'full', position: 0 },
  { id: '2', type: 'pipeline_by_stage', title: 'Pipeline by Stage', size: 'large', position: 1 },
  { id: '3', type: 'team_leads', title: 'Lead Distribution', size: 'large', position: 2 },
  { id: '4', type: 'forecast_vs_actual', title: 'Forecast vs Actual', size: 'large', position: 3 },
];
  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Team performance and pipeline overview</p>
      </div>
