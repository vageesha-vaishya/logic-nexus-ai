  ...
  const kanbanModules = [
    {
      ...
      stages: [
        { key: "new", label: "🔍 New Inquiry", count: stats.leads.byStage.new || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "contacted", label: "📞 Contact Attempted", count: stats.leads.byStage.contacted || 0, color: "bg-status-special text-status-special-foreground" },
        { key: "negotiation", label: "💬 In Discussion", count: stats.leads.byStage.negotiation || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "proposal", label: "📋 Requirements Gathering", count: stats.leads.byStage.proposal || 0, color: "bg-status-warning text-status-warning-foreground" },
        { key: "qualified", label: "🎯 Qualified Lead", count: stats.leads.byStage.qualified || 0, color: "bg-status-success text-status-success-foreground" },
        { key: "lost", label: "❌ Disqualified", count: stats.leads.byStage.lost || 0, color: "bg-status-danger text-status-danger-foreground" },
        { key: "won", label: "✅ Converted to Opportunity", count: stats.leads.byStage.won || 0, color: "bg-status-success text-status-success-foreground" },
      ],
    ...
    },
    {
      ...
      stages: [
        { key: "prospecting", label: "🆕 New Opportunity", count: stats.opportunities.byStage.prospecting || 0, color: "bg-status-neutral text-status-neutral-foreground" },
        { key: "qualification", label: "💰 Quote Requested", count: stats.opportunities.byStage.qualification || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "proposal", label: "📄 Quote Submitted", count: stats.opportunities.byStage.proposal || 0, color: "bg-status-special text-status-special-foreground" },
        { key: "negotiation", label: "🤝 Negotiation", count: stats.opportunities.byStage.negotiation || 0, color: "bg-status-warning text-status-warning-foreground" },
        { key: "value_proposition", label: "📝 Contract Review", count: stats.opportunities.byStage.value_proposition || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "needs_analysis", label: "📋 Requirements Gathering", count: stats.opportunities.byStage.needs_analysis || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "closed_won", label: "✅ Won", count: stats.opportunities.byStage.closed_won || 0, color: "bg-status-success text-status-success-foreground" },
        { key: "closed_lost", label: "❌ Lost", count: stats.opportunities.byStage.closed_lost || 0, color: "bg-status-danger text-status-danger-foreground" },
      ],
    ...
    },
    {
      ...
      stages: [
        { key: "draft", label: "✏️ Draft", count: stats.quotes.byStatus.draft || 0, color: "bg-status-neutral text-status-neutral-foreground" },
        { key: "pricing_review", label: "🔍 Pricing Review", count: stats.quotes.byStatus.pricing_review || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "approved", label: "✅ Approved", count: stats.quotes.byStatus.approved || 0, color: "bg-status-success text-status-success-foreground" },
        { key: "sent", label: "📧 Sent", count: stats.quotes.byStatus.sent || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "customer_reviewing", label: "👀 Customer Reviewing", count: stats.quotes.byStatus.customer_reviewing || 0, color: "bg-status-info text-status-info-foreground" },
        { key: "revision_requested", label: "🔄 Revision Requested", count: stats.quotes.byStatus.revision_requested || 0, color: "bg-status-warning text-status-warning-foreground" },
        { key: "accepted", label: "✅ Accepted", count: stats.quotes.byStatus.accepted || 0, color: "bg-status-success text-status-success-foreground" },
        { key: "rejected", label: "❌ Rejected", count: stats.quotes.byStatus.rejected || 0, color: "bg-status-danger text-status-danger-foreground" },
        { key: "expired", label: "⏰ Expired", count: stats.quotes.byStatus.expired || 0, color: "bg-status-warning text-status-warning-foreground" },
      ],
    ...
    },
    {
      ...
      stages: [
        { label: "Confirmed", count: stats.shipments.byStatus.confirmed || 0, color: "bg-status-info text-status-info-foreground" },
        { label: "In Transit", count: stats.shipments.byStatus.in_transit || 0, color: "bg-status-special text-status-special-foreground" },
        { label: "Out for Delivery", count: stats.shipments.byStatus.out_for_delivery || 0, color: "bg-status-warning text-status-warning-foreground" },
        { label: "Delivered", count: stats.shipments.byStatus.delivered || 0, color: "bg-status-success text-status-success-foreground" },
      ],
    ...
    },
    {
      ...
      stages: [
        { label: "Planned", count: stats.activities.byStatus.planned || 0, color: "bg-status-info text-status-info-foreground" },
        { label: "In Progress", count: stats.activities.byStatus.in_progress || 0, color: "bg-status-special text-status-special-foreground" },
        { label: "Completed", count: stats.activities.byStatus.completed || 0, color: "bg-status-success text-status-success-foreground" },
        { label: "Cancelled", count: stats.activities.byStatus.cancelled || 0, color: "bg-status-danger text-status-danger-foreground" },
      ],
