  ...
  const kanbanModules = [
    {
      ...
      stages: [
        { label: "🔍 New Inquiry", count: stats.leads.byStage.new || 0, color: "bg-blue-500/10 text-blue-700" },
        { label: "📞 Contact Attempted", count: stats.leads.byStage.contacted || 0, color: "bg-purple-500/10 text-purple-700" },
        { label: "💬 In Discussion", count: stats.leads.byStage.negotiation || 0, color: "bg-cyan-500/10 text-cyan-700" },
        { label: "📋 Requirements Gathering", count: stats.leads.byStage.proposal || 0, color: "bg-yellow-500/10 text-yellow-700" },
        { label: "🎯 Qualified Lead", count: stats.leads.byStage.qualified || 0, color: "bg-green-500/10 text-green-700" },
        { label: "❌ Disqualified", count: stats.leads.byStage.lost || 0, color: "bg-red-500/10 text-red-700" },
        { label: "✅ Converted to Opportunity", count: stats.leads.byStage.won || 0, color: "bg-emerald-500/10 text-emerald-700" },
      ],
    ...
    },
    {
      ...
      stages: [
        { label: "🆕 New Opportunity", count: stats.opportunities.byStage.prospecting || 0, color: "bg-slate-500/10 text-slate-700" },
        { label: "💰 Quote Requested", count: stats.opportunities.byStage.qualification || 0, color: "bg-blue-500/10 text-blue-700" },
        { label: "📄 Quote Submitted", count: stats.opportunities.byStage.proposal || 0, color: "bg-purple-500/10 text-purple-700" },
        { label: "🤝 Negotiation", count: stats.opportunities.byStage.negotiation || 0, color: "bg-orange-500/10 text-orange-700" },
        { label: "📝 Contract Review", count: stats.opportunities.byStage.value_proposition || 0, color: "bg-indigo-500/10 text-indigo-700" },
        { label: "📋 Requirements Gathering", count: stats.opportunities.byStage.needs_analysis || 0, color: "bg-cyan-500/10 text-cyan-700" },
        { label: "✅ Won", count: stats.opportunities.byStage.closed_won || 0, color: "bg-green-500/10 text-green-700" },
        { label: "❌ Lost", count: stats.opportunities.byStage.closed_lost || 0, color: "bg-red-500/10 text-red-700" },
      ],
    ...
    },
    {
      ...
      stages: [
        { label: "✏️ Draft", count: stats.quotes.byStatus.draft || 0, color: "bg-gray-500/10 text-gray-700" },
        { label: "🔍 Pricing Review", count: stats.quotes.byStatus.pricing_review || 0, color: "bg-indigo-500/10 text-indigo-700" },
        { label: "✅ Approved", count: stats.quotes.byStatus.approved || 0, color: "bg-green-500/10 text-green-700" },
        { label: "📧 Sent", count: stats.quotes.byStatus.sent || 0, color: "bg-blue-500/10 text-blue-700" },
        { label: "👀 Customer Reviewing", count: stats.quotes.byStatus.customer_reviewing || 0, color: "bg-cyan-500/10 text-cyan-700" },
        { label: "🔄 Revision Requested", count: stats.quotes.byStatus.revision_requested || 0, color: "bg-amber-500/10 text-amber-700" },
        { label: "✅ Accepted", count: stats.quotes.byStatus.accepted || 0, color: "bg-emerald-500/10 text-emerald-700" },
        { label: "❌ Rejected", count: stats.quotes.byStatus.rejected || 0, color: "bg-red-500/10 text-red-700" },
        { label: "⏰ Expired", count: stats.quotes.byStatus.expired || 0, color: "bg-orange-500/10 text-orange-700" },
      ],
