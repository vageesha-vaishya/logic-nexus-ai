    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <RoleGuard roles={[]} permissions={["admin.settings.manage"]} fallback={
            <Card>
              <CardHeader>
                <div className="flex items-center gap-2">
              ...
              <CardContent className="space-y-3">
                <CardDescription>Export data and manage database settings. Requires admin access.</CardDescription>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <CardDescription>Export your database as JSON and configure sequences.</CardDescription>
                <Button asChild className="w-full">
                  <Link to="/dashboard/settings/data-management">Open Data Management</Link>
                </Button>
              </CardContent>
            </Card>
          </RoleGuard>
