 ...
 * 
 * ENDPOINTS:
 * - GET  /api/v2/amro/work-order-template-versions?template_id=uuid (list versions)
 * - POST /api/v2/amro/work-order-template-versions (create new version - starts as draft)
 * 
 * FEATURES:
