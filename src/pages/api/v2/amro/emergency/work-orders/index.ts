 ...
 * - Uses existing table: amro_emergency_work_orders (created 2026-04-12)
 ...
 * 
 * ENDPOINTS:
 * - GET    /api/v2/amro/emergency/work-orders (list emergency WPs)
 * - POST   /api/v2/amro/emergency/work-orders (create emergency WP)
 * - GET    /api/v2/amro/emergency/work-orders/[id] (get details)
 * - POST   /api/v2/amro/emergency/work-orders/[id]/resolve (mark as resolved)
 * 
 * FEATURES:
...
export default async function handler(req: ApiRequest, res: ApiResponse): Promise<void> {
  ...
  try {
    ...
    if (req.method === 'GET') {
      ...
      res.status(200).json({
        version: 'v2',
        interface: 'list-emergency-work-orders',
    ...
    if (req.method === 'POST') {
      ...
      res.status(201).json({
        version: 'v2',
        interface: 'create-emergency-work-order',
        correlationId: ctx.correlationId,
        output: {
          work_order_id: wp.id,
