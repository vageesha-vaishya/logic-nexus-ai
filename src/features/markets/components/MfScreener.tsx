...
function CategoryBadge({ category }: { category: string | null }) {
  if (!category) return null;
  /* eslint-disable no-restricted-syntax -- fund-category chips: nine distinct hues are the badge's purpose; status tones would collapse them to five and make Debt/FoF read as warnings (design-system README §4.5) */
