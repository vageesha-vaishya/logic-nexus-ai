...
export const logisticsManifest: DomainManifest = {
  ...
  routes: [
    ...
    },
    {
      ...
      component:  () => import("@/pages/dashboard/Contacts"),
      moduleCode: "logistics.contacts",
      label:      "Contacts",
    },
    {
      path:       "/dashboard/opportunities",
      component:  () => import("@/pages/dashboard/Opportunities"),
      moduleCode: "logistics.opportunities",
      label:      "Opportunities",
    },
    {
      path:       "/dashboard/shipments",
      component:  () => import("@/pages/dashboard/Shipments"),
      moduleCode: "logistics.shipments",
      label:      "Shipments",
    },
    {
      path:       "/dashboard/carriers",
      component:  () => import("@/pages/dashboard/Carriers"),
      moduleCode: "logistics.carriers",
      label:      "Carriers",
    },
  ],
