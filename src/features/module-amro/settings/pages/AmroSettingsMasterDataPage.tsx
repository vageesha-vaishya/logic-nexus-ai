...
type WorkOrderTrigger = 'schedule_due' | 'defect' | 'campaign' | 'predictive_alert';
...
// AircraftWorkOrderRecordSummary + AircraftWorkOrderTaskListItem moved to ./amro-settings-master-data/helpers
