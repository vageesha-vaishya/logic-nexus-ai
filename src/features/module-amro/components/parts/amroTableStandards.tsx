...
export const amroTableClassNames = {
  ...
  th: 'sticky top-0 z-10 bg-slate-50 px-3 py-2 text-xs font-semibold uppercase tracking-wide text-slate-600',
...
export const amroCompactTableClassNames = {
  ...
  thead: 'bg-slate-50 text-left',
  th: 'sticky top-0 z-10 bg-slate-50 px-2 py-1.5 text-xs font-semibold uppercase tracking-wide text-slate-600',
  row: 'border-t border-slate-200',
