...
export const APP_MENU: MenuModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Work Packages Templates', path: '/dashboard/amro/settings/master-data/work-packages', icon: Package, description: 'Work package templates linked to aircraft operations', permissions: ['edit_aircraft_records'] },
