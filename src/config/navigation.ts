...
export const APP_MENU: MenuModule[] = [
  ...
  },
  {
    label: 'AMRO',
    items: [
      { name: 'AMRO Overview', path: '/dashboard/amro/overview', icon: BarChart3, description: 'Maintenance overview and KPI shell', permissions: ['view_amro_dashboard'] },
      { name: 'AMRO Work Packages', path: '/dashboard/amro/work-packages', icon: CheckSquare, description: 'Maintenance work package execution board', permissions: ['create_maintenance_request'] },
      { name: 'AMRO Task Execution', path: '/dashboard/amro/task-execution', icon: CheckSquare, description: 'Technician task execution operations', permissions: ['create_maintenance_request'] },
      { name: 'AMRO Scheduling', path: '/dashboard/amro/scheduling', icon: CalendarDays, description: 'Maintenance scheduling shell', permissions: ['edit_aircraft_records'] },
      { name: 'AMRO Parts', path: '/dashboard/amro/parts', icon: Box, description: 'Materials reservation and parts operations', permissions: ['edit_aircraft_records'] },
      { name: 'AMRO Compliance', path: '/dashboard/amro/compliance', icon: FileCheck, description: 'Compliance gate and release controls', permissions: ['approve_work_orders'] },
      { name: 'AMRO Certification', path: '/dashboard/amro/certification', icon: FileCheck, description: 'Certification decision and certifying release workflows', permissions: ['approve_work_orders'] },
      { name: 'AMRO Audit', path: '/dashboard/amro/audit', icon: FileText, description: 'Audit replay timeline and traceability', permissions: ['delete_flight_logs'] },
      { name: 'AMRO Integration', path: '/dashboard/amro/integration', icon: GitBranch, description: 'Integration monitor and sync operations', permissions: ['edit_aircraft_records'] },
      { name: 'AMRO Intelligence', path: '/dashboard/amro/intelligence', icon: TrendingUp, description: 'Forecast recommendation and risk intelligence', permissions: ['view_amro_dashboard'] },
    ],
  },
  {
    label: 'Compliance',
