...
export const APP_MENU: MenuModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'AMRO Task Execution', path: '/dashboard/amro/task-execution', icon: CheckSquare, description: 'Technician task execution operations' },
      { name: 'AMRO Scheduling', path: '/dashboard/amro/scheduling', icon: CalendarDays, description: 'Maintenance scheduling shell' },
      { name: 'AMRO Parts', path: '/dashboard/amro/parts', icon: Box, description: 'Materials reservation and parts operations' },
      { name: 'AMRO Compliance', path: '/dashboard/amro/compliance', icon: FileCheck, description: 'Compliance gate and release controls' },
      { name: 'AMRO Certification', path: '/dashboard/amro/certification', icon: FileCheck, description: 'Certification decision and certifying release workflows' },
      { name: 'AMRO Audit', path: '/dashboard/amro/audit', icon: FileText, description: 'Audit replay timeline and traceability' },
      { name: 'AMRO Integration', path: '/dashboard/amro/integration', icon: GitBranch, description: 'Integration monitor and sync operations' },
      { name: 'AMRO Intelligence', path: '/dashboard/amro/intelligence', icon: TrendingUp, description: 'Forecast recommendation and risk intelligence' },
