...
## Scope
- Rename: `work_order_templates` -> `work_order_templates`
- Date: `2026-04-25`
...
- Migration: `supabase/migrations/20260425110000_amro_rename_work_order_templates_to_work_order_templates.sql`
- Rollback: `supabase/rollback/20260425110000_amro_rename_work_order_templates_to_work_order_templates_down.sql`
