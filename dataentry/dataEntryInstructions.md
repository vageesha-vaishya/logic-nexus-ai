...
PLAYWRIGHT_REUSE_EXISTING_SERVER=true DATAENTRY_EMAIL="mgl.tenant.admin.001@gmail.com" DATAENTRY_PASSWORD="Vimal@1234" npx playwright test dataentry/UserCreation.spec.ts --config playwright.config.ts --project=chromium --headed