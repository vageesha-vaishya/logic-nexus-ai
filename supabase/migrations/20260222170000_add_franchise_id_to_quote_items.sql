-- Migration: Add franchise_id to quote_items_core and logistics.quote_items_extension
...
BEGIN
    ...
    IF (TG_OP = 'INSERT') THEN
        ...
        INSERT INTO public.quote_items_core (
            id, quote_id, tenant_id, franchise_id, line_number, product_name, description,
            commodity_id, aes_hts_id,
            quantity, unit_price, discount_percent, discount_amount,
            tax_percent, tax_amount, line_total, created_at, updated_at
        ) VALUES (
            new_id, NEW.quote_id, NEW.tenant_id, NEW.franchise_id, NEW.line_number, NEW.product_name, NEW.description,
        ...
        INSERT INTO logistics.quote_items_extension (
            quote_item_id, tenant_id, franchise_id, package_category_id, package_size_id, cargo_type_id, service_type_id,
            weight_kg, volume_cbm, special_instructions, attributes,
            type, container_type_id, container_size_id
        ) VALUES (
            new_id, NEW.tenant_id, NEW.franchise_id, NEW.package_category_id, NEW.package_size_id, NEW.cargo_type_id, NEW.service_type_id,
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
        ...
        INSERT INTO logistics.quote_items_extension (
            ...
            OLD.id, COALESCE(NEW.tenant_id, OLD.tenant_id), COALESCE(NEW.franchise_id, OLD.franchise_id), NEW.package_category_id, NEW.package_size_id, NEW.cargo_type_id, NEW.service_type_id,
            NEW.weight_kg, NEW.volume_cbm, NEW.special_instructions, v_attributes,
            NEW.type, NEW.container_type_id, NEW.container_size_id
        )
