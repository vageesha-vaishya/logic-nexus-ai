-- Migration to ensure save_quote_atomic function handles origin_location_id and destination_location_id
-- for transport legs, ensuring proper linking to ports_locations table.
