...
INSERT INTO public.ports_locations (tenant_id, location_name, location_code, location_type, country, city, state_province, customs_available, is_active, notes)
SELECT NULL, 'Montr├®alÔÇôTrudeau International Airport', 'YUL', 'airport', 'Canada', 'Montr├®al', 'Quebec', TRUE, TRUE, 'Global seed'
...
INSERT INTO public.ports_locations (tenant_id, location_name, location_code, location_type, country, city, state_province, customs_available, is_active, notes)
SELECT NULL, 'Port of Montr├®al', 'CAMTR', 'seaport', 'Canada', 'Montr├®al', 'Quebec', TRUE, TRUE, 'Global seed'
...
INSERT INTO public.ports_locations (tenant_id, location_name, location_code, location_type, country, city, state_province, customs_available, is_active, notes)
SELECT NULL, 'Monterrey International Airport', 'MTY', 'airport', 'Mexico', 'Monterrey', 'Nuevo Le├│n', TRUE, TRUE, 'Global seed'
...
INSERT INTO public.ports_locations (tenant_id, location_name, location_code, location_type, country, city, state_province, customs_available, is_active, notes)
SELECT NULL, 'Port of L├ízaro C├írdenas', 'MXLZC', 'seaport', 'Mexico', 'L├ízaro C├írdenas', 'Michoac├ín', TRUE, TRUE, 'Global seed'
...
INSERT INTO public.ports_locations (tenant_id, location_name, location_code, location_type, country, city, state_province, customs_available, is_active, notes)
SELECT NULL, 'L├ízaro C├írdenas Terminal (APM)', 'MXLZC-T1', 'terminal', 'Mexico', 'L├ízaro C├írdenas', 'Michoac├ín', TRUE, TRUE, 'Global seed (extended)'
