        ...
        for (const m of messages) {
          try {
            ...
            const emailPayload = {
              ...
              toRecipients: toRecipients.map((r: { email: string }) => r.email),
              ccRecipients: ccRecipients.map((r: { email: string }) => r.email),
              bccRecipients: bccRecipients.map((r: { email: string }) => r.email),
