...
// JWT verification + tenant/franchise scope extraction. Env vars (CRM_AUTH_*)
// keep their crm-prefixed names because they configure the platform-wide
// Supabase auth, not crm-api specifically — both services read the same
// JWT issuer and should share monitoring config.
