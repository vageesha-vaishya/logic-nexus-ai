...
import { authMiddleware, AuthRequest, getAuthHeaderMonitoringSnapshot } from './middleware/auth.middleware.js';
import masterDataRoutes from './routes/master-data.routes.js';
import workOrdersRoutes from './routes/work-orders.routes.js';
import workOrderTemplateRoutes from './routes/work-order-template.routes.js';
import partsRoutes from './routes/parts.routes.js';
import itemMasterRoutes from './routes/item-master.routes.js';
import mpdRoutes from './routes/mpd.routes.js';
import directivesRoutes from './routes/directives.routes.js';
import configureMpdRoutes from './routes/configure-mpd.routes.js';
...
import { executeWithResilience, getResilienceStatus } from './utils/resilience.js';
